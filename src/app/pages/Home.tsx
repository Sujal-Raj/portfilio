        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              ...
              <blockquote className="text-2xl lg:text-3xl font-light italic mb-8 text-gray-200">
                ...
                <div className="flex space-x-4">
                  {[
                    ...
                    <motion.a
                      key={social.label}
                      href={social.href}
                      className="w-12 h-12 bg-white bg-opacity-10 rounded-full flex items-center justify-center hover:bg-yellow-400 hover:text-black transition-all duration-300"
